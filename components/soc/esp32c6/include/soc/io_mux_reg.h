...
#define PERIPHS_IO_MUX_GPIO41_U           (REG_IO_MUX_BASE +0xa8)
#define FUNC_GPIO41_GPIO41                          1
#define FUNC_GPIO41_GPIO41_0                        0

#define PERIPHS_IO_MUX_GPIO42_U           (REG_IO_MUX_BASE +0xac)
#define FUNC_GPIO42_GPIO42                          1
#define FUNC_GPIO42_GPIO42_0                        0

#define PERIPHS_IO_MUX_GPIO43_U           (REG_IO_MUX_BASE +0xb0)
#define FUNC_GPIO43_GPIO43                          1
#define FUNC_GPIO43_GPIO43_0                        0

#define PERIPHS_IO_MUX_GPIO44_U           (REG_IO_MUX_BASE +0xb4)
...
#define IO_MUX_DATE_VERSION 0x2007060
