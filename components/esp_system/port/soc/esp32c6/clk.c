 ...
 */
#define SLOW_CLK_CAL_CYCLES     CONFIG_ESP32C6_RTC_CLK_CAL_CYCLES
 ...
 __attribute__((weak)) void esp_clk_init(void)
{
...
#if defined(CONFIG_ESP32C6_RTC_CLK_SRC_EXT_CRYS)
    select_rtc_slow_clk(SLOW_CLK_32K_XTAL);
#elif defined(CONFIG_ESP32C6_RTC_CLK_SRC_EXT_OSC)
    select_rtc_slow_clk(SLOW_CLK_32K_EXT_OSC);
#elif defined(CONFIG_ESP32C6_RTC_CLK_SRC_INT_8MD256)
    ...
    const uint32_t new_freq_mhz = CONFIG_ESP32C6_DEFAULT_CPU_FREQ_MHZ;
